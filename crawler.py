...
total_page = 1
url = 'https://api.niftygateway.com/market/all-data/?page={%22current%22:'+str(total_page)+',%22size%22:20}&filters={%22exclude_types%22:[%22withdrawals%22,%22primary_market_sales%22,%22single_nifty_offers%22,%22global_nifty_offers%22,%22attribute_nifty_offers%22,%22primary_market_bids%22,%22gifts%22,%22deposits%22,%22listings%22],%22date_start%22:%22'+start_date+'+00:00:00%22,%22date_end%22:%22'+end_date+'+23:59:59%22}'
...
def get_url(page):
    ...
    for i in range(1,page):
        url = 'https://api.niftygateway.com/market/all-data/?page={%22current%22:'+str(i)+',%22size%22:20}&filters={%22exclude_types%22:[%22withdrawals%22,%22primary_market_sales%22,%22single_nifty_offers%22,%22global_nifty_offers%22,%22attribute_nifty_offers%22,%22primary_market_bids%22,%22gifts%22,%22deposits%22,%22listings%22],%22date_start%22:%22'+start_date+'+00:00:00%22,%22date_end%22:%22'+end_date+'+23:59:59%22}'
        url_list.append(url)
    return url_list

#sales 중 sale만 받아오기
url = 'https://api.niftygateway.com/market/all-data/?page={%22current%22:1,%22size%22:20}&filters={%22exclude_types%22:[%22withdrawals%22,%22primary_market_sales%22,%22single_nifty_offers%22,%22global_nifty_offers%22,%22attribute_nifty_offers%22,%22primary_market_bids%22,%22gifts%22,%22deposits%22,%22listings%22],%22date_start%22:%22'+start_date+'+00:00:00%22,%22date_end%22:%22'+end_date+'+23:59:59%22}'
