...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_dir", type=str, default="/opt/ml/final-project-level3-recsys-01/data/data-preprocessing", help="input data directory")
    parser.add_argument("--model_dir", type=str, default="/opt/ml/final-project-level3-recsys-01/model", help="model directory")
    ...
    parser.add_argument("--output_dir", type=str, default="/opt/ml/final-project-level3-recsys-01/output")
